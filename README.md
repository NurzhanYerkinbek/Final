For our every html files we have css files and js files. First we go to Homepage and we used navbar and button and hocer everthing there. For every pages we used linear-gradient
